 ...
 */
GLPendulum::GLPendulum(float length, Vector3D* base) : _base(base), _length(length), _showArrows(false), _label(NULL)
{
	//Initialize quadric objects
	// NOTE: render context needs to be created before this otherwise the
	// memory system will throw a bus error
